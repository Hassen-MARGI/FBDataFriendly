    ...
    while not stop_event.is_set():
        for conversation_namee in settings.conversation_name:
            ...
            try:
                ...
                try:
                    sleep(1);
                    driver.find_element(By.XPATH, '//span[contains(@class, "x193iq5w") and text()="Media"]')
                except NoSuchElementException:
                    sleep(1)
                    driver.find_element(By.XPATH, '//span[starts-with(text(), "Media, files")]').click()
                wait.until(
                    EC.presence_of_element_located(
                        (By.XPATH, '//span[contains(@class, "x193iq5w") and text()="Media"]')))
            ...
            if parent_div:
                ...
                first_image.click()
                wait.until(
                    EC.presence_of_element_located((By.XPATH, '//img[@class="x4ju7c5 xt7dq6l x193iq5w x14atkfc"]')))
